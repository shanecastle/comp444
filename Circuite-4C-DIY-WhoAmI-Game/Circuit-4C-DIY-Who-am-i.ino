/* COMP444 - Circuit 4C - Heads Up Game
...
void loop()
{
    ...
    { // for each of the 25 words in the sequence
        ...
        { // do this until the button is pressed...
            ...
            {               // if the time limit is up before the button is pressed
...
void generateRandomOrder()
{
    ...
    for (int i = 0; i < arraySize; i++)
    { // do this until all 25 positions are filled
        ...
        do
        {
            ...
            for (int i = 0; i < arraySize; i++)
            { // for all 25 numbers in the array
                if (currentNumber == sequence[i])
                {                 // does the currentNumber match any of the numbers?
